...
class Server:
    def __init__(self, test) -> None:
        ...
        if test:
            ...
            self.broadcast_addr = '172.99.121.121'
        else:
            self.IP = get_if_addr('eth1')
            self.broadcast_addr = '172.1.121.121'
        ...
        self.server_tcp.bind(('', self.game_port))
        # self.server_tcp.settimeout(20)
        self.found = [] 
    ...
    def send_UDP_broadcast(self):
        ...
        self.sock_UDP.sendto(struct.pack('Ibh', 0xabcddcba, 0x2, self.game_port), (self.broadcast_addr, 13177))
            ...
            try:
                ...
                if len(self.found) < 2:  # stops incoming traffic, checks if # confirmed sockets greater than 2, 
                    ...
                    if len(self.found) == 2:
                        ...
                        self.team2_name = self.team_names[self.found[1]]
